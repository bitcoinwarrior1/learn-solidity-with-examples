...
contract BTC2ETH is BTC
{
    ...
    ) public
    {
        ...
        {
            require(keccak256(claimedTxs[i]) != keccak256(rawTransaction));
        }
        ...
        require(valid);
        var (amt1, address1, amt2, address2) = getFirstTwoOutputs(rawTransaction);
        require(address1 == bitcoinAddress || address2 == bitcoinAddress);
        bytes20 senderPubKey = parseOutputScript(
            rawTransaction,
            0,
        ...
        claimedTxs.push(rawTransaction);
    }
