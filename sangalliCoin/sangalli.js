...
sangallicoin.deposit.sendTransaction({from: eth.accounts[0], value: 100000000000000000});

sangallicoin.denyWithdrawal.sendTransaction(21, "0xdc85a8429998bd4eef79307e556f70bb70d8caf1", 5000000000, {from: eth.coinbase})

sangallicoin.attemptWithdrawal.sendTransaction(100000000000000000, {from:eth.accounts[0]});

sangallicoin.withdraw.sendTransaction(40000000000000000,"0xdc85a8429998bd4eef79307e556f70bb70d8caf1",  20000000000, 21,{from:eth.coinbase});

sangallicoin.checkBalance.call({from:eth.coinbase});

sangallicoin.checkBalance.call({from:eth.accounts[1]});

sangallicoin.sellOffer.sendTransaction(10000000000000000, 20000000000000000, {from:eth.coinbase}); //selling sangalliCoins at double the IPO price

sangallicoin.buy.sendTransaction(10000000000000000, 20000000000000000, {from:eth.accounts[1], value: 20000000000000000}); //buying sangalliCoins at double the IPO price

sangallicoin.transfer.sendTransaction(eth.accounts[0], 19999999999999998, {from:eth.accounts[1]})
